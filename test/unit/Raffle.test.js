...
!developmentChains.includes(network.name)
    ? describe.skip
    : describe("Raffle Unit Tests", function () /* async is not used with describe because describe cannot work with promises ,
         so there is no use of using async , it doesn't recognise it */
      {
          ...
          beforeEach(async function () {
              ...
              raffle = raffleContract.connect(signedDeployer)
          ...
          describe("Enter Raffle", function () {
              ...
              it("Emits event on entering raffle", async function () {
          ...
          describe("Check Upkeep", function () {
              it("Returns False if No ETH Send", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
                  const { upkeepNeeded } = await raffle.callStatic.checkUpkeep([])
                  // Simulating a call to the function without making a transaction
                  assert(!upkeepNeeded)
              })
          ...
          describe("Function Fulfill Random Words", function () {
              ...
              it("Picks a Winner , Resets the Lottery and sends money", async function () {
                  ...
                  await new Promise(async (resolve, reject) => {
                      ...
                      // Calling the VRF Coordinator fulfillRandomWords Function
                  })
              })
          })
      })
